  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        {/* Recent matches */}
        <div className="mb-6">
          <h3 className="text-md font-medium text-gray-700 mb-3">{t('matches.title')}</h3>
        ...
        {/* Recent jobs */}
        <div className="mb-6">
          <h3 className="text-md font-medium text-gray-700 mb-3">{t('jobs.title')}</h3>
          <div className="space-y-4">
        ...
        {/* Recent candidates */}
        <div>
          <h3 className="text-md font-medium text-gray-700 mb-3">{t('candidates.title')}</h3>
          <div className="space-y-4">
